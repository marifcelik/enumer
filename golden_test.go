...
func runGoldenTest(t *testing.T, test Golden,
	...
	trimPrefix, prefix, trimSuffix, suffix string) {
	...
	g.generate(tokens[1], generateJSON, generateYAML, generateSQL, generateText, generateGQLGen, "noop", trimPrefix, prefix, trimSuffix, suffix, linecomment, generateValuesMethod)
	got := string(g.format())
